   ...
   <el-row :gutter="20">
    ...
    <el-table
      ...
      <!-- <el-table-column
        ...
        align="center"
        label="员工头像"> -->
        <!-- <img :src="dataList.epPortrait" width="50%" height="50%"> -->
        <!-- <el-image
      ...
      <!-- <el-table-column
        ...
        label="操作">
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="UpdateHandleById(scope.row.epId)">聘用</el-button>
          <el-button type="text" size="small" @click="NoUpdateHandleById(scope.row.epId)">不聘用</el-button>
        </template>
      </el-table-column> -->
       <!-- <el-table-column fixed="right" prop="epEmpoyeeStatus" header-align="center" align="center" label="聘用状态">
        <template slot-scope="scope">
            <el-button v-if="scope.row.epEmpoyeeStatus == 3 ||scope.row.epEmpoyeeStatus == 4" type="text" size="small" @click="UpdateHandleById(scope.row.epId)">聘用</el-button>
          <el-button v-if="scope.row.epEmpoyeeStatus == 3 ||scope.row.epEmpoyeeStatus == 4" type="text" size="small" @click="NoUpdateHandleById(scope.row.epId)">不聘用</el-button>
...
import Category1 from '../common/category1'
 import AddOrUpdate from '../emp/selectEmployee'
export default {
   components:{ Category1,AddOrUpdate},
       data () {
      return {
        dataForm: {
          key: ''
    ...
    getCategoryEmpList(){
      this.dataListLoading = true
        this.$http({
          url: this.$http.adornUrl(`/employee/employee/list1/${this.cpId}`),
          method: 'get',
