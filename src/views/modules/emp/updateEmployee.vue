    ...
    :inactive-value="0">
      ...
      <el-form-item label="请选择岗位" prop="epJobId" v-model="cpName2">
       ...
       <el-form-item label="公司名称" prop="epTargetPay">
            ...
            <el-form-item>
              <el-button type="success" @click="collectSpuBaseInfo">下一步：个人证件信息</el-button>
            </el-form-item>
          </el-form>
        </el-card>
      </el-col>
      ...
      <div class="main">
        ...
        个人介绍： <p v-html="employee.epIntroduction" >{{employee.epIntroduction}}</p>
        其他： <p v-html="employee.epOther" >{{employee.epOther}}</p>
          ...
          <el-card class="box-card">
            ...
            <el-button type="success" @click="submitIntro">下一步：修改</el-button>
          </el-card>
        </el-card>
      </el-col>
...
export default {
  ...
  methods: {
      init(id){
          this.visible = true
          this.$http({
          url: this.$http.adornUrl(`/employee/employee/list/emp/${id}`),
          method: 'get',
